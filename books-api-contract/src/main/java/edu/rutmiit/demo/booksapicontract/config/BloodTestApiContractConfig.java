...
/**
 * Центральная OpenAPI-конфигурация контракта BloodTests API.
 *
...
@OpenAPIDefinition(
        info = @Info(
                title = "Blood Count API",
                version = "1.0.0",
                description = """
                        REST API для управления результатами анализа крови.
                        """
        ),
        servers = {
...
@SecurityScheme(
        name = BloodTestApiContractConfig.SECURITY_SCHEME_BEARER,
...
public final class BloodTestApiContractConfig {
    ...
    private BloodTestApiContractConfig() {
        // utility class
    }
}
